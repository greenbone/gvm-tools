...
.. glossary::
  ...
  gvmd
    Management daemon shipped with `GVM 10
    <https://community.greenbone.net/t/gvm-10-beta/208>`_.

  openvasmd
    Management daemon shipped with `OpenVAS 9
    <https://community.greenbone.net/t/gvm-9-stable-initial-release-2017-03-07/211>`_
    and before.

  openvassd
    Scanner daemon used by GVM. Runs the actual vulnerability tests and reports
